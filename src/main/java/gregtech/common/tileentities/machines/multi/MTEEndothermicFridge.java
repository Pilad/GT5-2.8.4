...
public class MTEEndothermicFridge extends MTEExtendedPowerMultiBlockBase<MTEEndothermicFridge>
    ...
    //spotless:on
        ...
        .addElement('I', ofFrame(Materials.Ledox))
        .addElement(
            'J',
            ofBlocksTiered(
    ...
    private static final List<BoosterFluid> BOOSTER_FLUIDS = ImmutableList.of(
        ...
        new BoosterFluid(MaterialsUEVplus.SpaceTime, 4f, BOOSTER_DRAIN),
        new BoosterFluid(MaterialsUEVplus.Eternity, 8f, BOOSTER_DRAIN));
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        ...
        ButtonWidget cryoButton = new ButtonWidget();

        builder.widget(cryoButton.setOnClick((clickData, widget) -> {
            isCryoEnabled = !isCryoEnabled;
            ...
            .setBackground(() -> {
                ...
                if (isCryoEnabled) {
                    ...
                    ret.add(GTUITextures.OVERLAY_BUTTON_CRYOTHEUM_ON);
                } else {
                    ret.add(GTUITextures.BUTTON_STANDARD);
                    ret.add(GTUITextures.OVERLAY_BUTTON_CRYOTHEUM_OFF);
                }
            ...
            .dynamicTooltip(() -> {
                ...
                if (isCryoEnabled) {
                    textList.add(StatCollector.translateToLocal("GT5U.gui.text.button.cryotheum.enabled"));
                } else {
                    textList.add(StatCollector.translateToLocal("GT5U.gui.text.button.cryotheum.disabled"));
                }
                return textList;
            })
            .attachSyncer(
                new FakeSyncWidget.BooleanSyncer(() -> isCryoEnabled, val -> isCryoEnabled = val)
                    .setOnClientUpdate(val -> cryoButton.notifyTooltipChange()),
                builder)
            .setPos(80, 91)
            .setSize(16, 16));
    }
