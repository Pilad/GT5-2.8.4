...
public class MTEIndustrialBendingMachine extends MTEExtendedPowerMultiBlockBase<MTEIndustrialBendingMachine>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("Bending Machine, IBM")
            ...
            .addCasingInfoMin("Material Press Machine Casing", 4, false)
            ...
            .addInputHatch("Any Material Press Machine Casing", 1)
            .addInputBus("Any Material Press Machine Casing", 1)
            .addOutputBus("Any Material Press Machine Casing", 1)
            .addEnergyHatch("Any Material Press Machine Casing", 1)
            .addMaintenanceHatch("Any Material Press Machine Casing", 1)
            .addMufflerHatch("Any Material Press Machine Casing", 1)
