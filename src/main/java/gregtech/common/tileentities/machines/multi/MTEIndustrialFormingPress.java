...
public class MTEIndustrialFormingPress extends MTEExtendedPowerMultiBlockBase<MTEIndustrialFormingPress>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("Forming Press")
            ...
            .addCasingInfoMin("Material Press Machine Casing", 5, false)
            ...
            .addInputHatch("Material Press Machine Casing", 1)
            .addInputBus("Material Press Machine Casing", 1)
            .addOutputBus("Material Press Machine Casing", 1)
            .addEnergyHatch("Material Press Machine Casing", 1)
            .addMaintenanceHatch("Material Press Machine Casing", 1)
            .addMufflerHatch("Material Press Machine Casing", 1)
    ...
    public boolean checkMachine(IGregTechTileEntity aBaseMetaTileEntity, ItemStack aStack) {
        casingAmount = 0;
        return checkPiece(STRUCTURE_PIECE_MAIN, OFFSET_X, OFFSET_Y, OFFSET_Z) && casingAmount >= 5 && checkHatch();
    }
