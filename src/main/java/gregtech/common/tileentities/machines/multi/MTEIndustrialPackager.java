...
import gregtech.common.tileentities.machines.multi.gui.MTEIndustrialPackagerGui;
...
public class MTEIndustrialPackager extends MTEExtendedPowerMultiBlockBase<MTEIndustrialPackager>
    ...
    @Override
    protected @NotNull MTEIndustrialPackagerGui getGui() {
        return new MTEIndustrialPackagerGui(this);
    }
