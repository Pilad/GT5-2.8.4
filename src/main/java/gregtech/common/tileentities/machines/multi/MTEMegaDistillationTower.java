...
public class MTEMegaDistillationTower extends MTEExtendedPowerMultiBlockBase<MTEMegaDistillationTower>
    ...
    static {
        ...
        STRUCTURE_DEFINITION = StructureDefinition.<MTEMegaDistillationTower>builder()
            ...
            .addElement('G', Casings.SteelFireboxCasing.asElement())
    ...
    public boolean checkMachine(IGregTechTileEntity baseMTE, ItemStack stack) {
        ...
        if (!checkPiece(STRUCTURE_PIECE_BASE, HORIZONTAL_OFFSET, VERTICAL_OFFSET, DEPTH_OFFSET)) return false;
        ...
        return this.casingAmount >= 150 && this.isTopLayerFound && this.mMaintenanceHatches.size() == 1;
    }
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        ...
        builder.widget(modeButton.setOnClick((clickData, widget) -> {
            ...
            .dynamicTooltip(() -> {
                ...
                textList.add(StatCollector.translateToLocal(getMachineModeKey()));
                return textList;
            })
            .attachSyncer(
                new FakeSyncWidget.IntegerSyncer(() -> machineMode, val -> machineMode = val)
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("Distillery, DT, MDT")
            ...
            .addCasingInfoExactly("Steel Firebox Casing", 179, false)
