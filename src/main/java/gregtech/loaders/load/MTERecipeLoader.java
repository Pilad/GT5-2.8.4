...
public class MTERecipeLoader implements Runnable {
    ...
    private static void registerReworkMigrationRecipes() {
        ...
        GTModHandler.addShapelessCraftingRecipe(
            ...
            new Object[] { GregtechItemList.Industrial_Extruder.get(1) });
        ...
        GTModHandler.addCraftingRecipe(
            ItemList.TreeGrowSimulator.get(1),
            GTModHandler.RecipeBits.BUFFERED,
            new Object[] { "FXF", "PHP", "FRF", 'F', ItemList.Field_Generator_IV, 'R',
        ...
        GTModHandler.addShapelessCraftingRecipe(
            ...
            new Object[] { ItemList.Machine_Multi_ExtremeDieselEngine.get(1) });
        ...
        GTModHandler.addShapelessCraftingRecipe(
            ...
            new Object[] { GregtechItemList.Large_Steam_Turbine.get(1) });
        GTModHandler.addShapelessCraftingRecipe(
            ItemList.HPSteamTurbineXL.get(1),
            new Object[] { GregtechItemList.Large_HPSteam_Turbine.get(1) });
        GTModHandler.addShapelessCraftingRecipe(
            ItemList.GasTurbineXL.get(1),
            new Object[] { GregtechItemList.Large_Gas_Turbine.get(1) });
        GTModHandler.addShapelessCraftingRecipe(
            ItemList.PlasmaTurbineXL.get(1),
            new Object[] { GregtechItemList.Large_Plasma_Turbine.get(1) });
        GTModHandler.addShapelessCraftingRecipe(
        ...
        GTModHandler.addShapelessCraftingRecipe(
            ...
            new Object[] { ItemList.PlanetaryGasSiphonController.get(1) });
    ...
    private static void registerShapedCraftingRecipes() {
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "GGG", "WSW", aTextPlateMotor, 'M', ItemList.Machine_Bronze_Boiler_Solar, 'P',
                ...
                OrePrefixes.plateDouble.get(Materials.WroughtIron), 'G', ItemList.ReinforcedGlass.get(1L) });
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "GPG", aTextWireHull, "CBC", 'M', ItemList.Hull_LV, 'P', ItemList.Electric_Pump_LV, 'B',
                MTEBasicMachineWithRecipe.X.PIPE, 'C', OrePrefixes.circuit.get(Materials.LV), 'W',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "GPG", aTextWireHull, "CBC", 'M', ItemList.Hull_MV, 'P', ItemList.Electric_Pump_MV, 'B',
                MTEBasicMachineWithRecipe.X.PIPE, 'C', OrePrefixes.circuit.get(Materials.MV), 'W',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "GPG", aTextWireHull, "CBC", 'M', ItemList.Hull_HV, 'P', ItemList.Electric_Pump_HV, 'B',
                MTEBasicMachineWithRecipe.X.PIPE, 'C', OrePrefixes.circuit.get(Materials.HV), 'W',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "GPG", aTextWireHull, "CBC", 'M', ItemList.Hull_EV, 'P', ItemList.Electric_Pump_EV, 'B',
                MTEBasicMachineWithRecipe.X.PIPE, 'C', OrePrefixes.circuit.get(Materials.EV), 'W',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "GPG", aTextWireHull, "CBC", 'M', ItemList.Hull_IV, 'P', ItemList.Electric_Pump_IV, 'B',
                MTEBasicMachineWithRecipe.X.PIPE, 'C', OrePrefixes.circuit.get(Materials.IV), 'W',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BITSD,
            new Object[] { "WEP", "ECE", "WMP", 'M', ItemList.Hull_MV, 'W', ItemList.Electric_Piston_MV, 'P',
                OrePrefixes.wireGt04.get(Materials.Cupronickel), 'E', OrePrefixes.circuit.get(Materials.MV), 'C',
                ItemList.Electric_Pump_MV });
        ...
        GTModHandler.addCraftingRecipe(
            ...
            GTModHandler.RecipeBits.BITSD,
            new Object[] { "GCG", "EME", "PWP", 'M', ItemList.Hull_IV, 'P', ItemList.Electric_Piston_IV, 'E',
                ItemList.Electric_Motor_IV, 'C', OrePrefixes.circuit.get(Materials.LuV), 'W',
                OrePrefixes.cableGt01.get(Materials.HSSG), 'G', OrePrefixes.gearGt.get(Materials.TungstenSteel) });
        GTModHandler.addCraftingRecipe(
