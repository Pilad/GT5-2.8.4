...
public class GTAchievements {
    ...
    public GTAchievements() {
        ...
        GTLog.out.println("Registering autogenerated achievements from Visual Assembly Line recipe map.");
    ...
    public Achievement registerAchievement(String textId, int x, int y, ItemStack icon, Achievement requirement,
        ...
        String name = "achievement." + textId;
        String desc = name + ".desc";

        if (!StatCollector.canTranslate(name)) {
            GTLog.out.println(name + "=" + icon.getDisplayName());
        }
