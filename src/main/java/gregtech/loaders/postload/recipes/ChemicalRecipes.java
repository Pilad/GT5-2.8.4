...
public class ChemicalRecipes implements Runnable {
    ...
    public void registerBoth() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Items.sugar, 8), GTOreDictUnificator.get(OrePrefixes.dust, Materials.Plastic, 1))
    ...
    public void multiblockOnly() {
        ...
        // Calcite
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.copyAmount(0, Materials.Quicklime.getDust(1)), GTUtility.getIntegratedCircuit(3))
            .fluidInputs(Materials.AceticAcid.getFluid(2_000))
            .fluidOutputs(
                Materials.Acetone.getFluid(1_000),
                Materials.CarbonDioxide.getGas(1_000),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.copyAmount(0, Materials.Calcite.getDust(1)), GTUtility.getIntegratedCircuit(3))
            .fluidInputs(Materials.AceticAcid.getFluid(2_000))
            .fluidOutputs(
                Materials.Acetone.getFluid(1_000),
                Materials.CarbonDioxide.getGas(1_000),
