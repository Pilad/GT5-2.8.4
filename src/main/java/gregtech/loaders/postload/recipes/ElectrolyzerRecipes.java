...
public class ElectrolyzerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.Methylamine.getGas(1_000))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.Trimethylamine.getGas(1_000))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(MaterialsKevlar.Isobutyraldehyde.getFluid(1_000))
            .fluidOutputs(Materials.Hydrogen.getGas(8_000))
            .duration(15 * SECONDS + 12 * TICKS)
            .eut(90)
            .addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemOutputs(Materials.Carbon.getDust(8))
            .fluidInputs(MaterialsKevlar.IIIDimethylbenzene.getFluid(1_000))
            .fluidOutputs(Materials.Hydrogen.getGas(10_000))
            .duration(21 * SECONDS + 12 * TICKS)
            .eut(60)
            .addTo(electrolyzerRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemOutputs(Materials.Carbon.getDust(8))
            .fluidInputs(MaterialsKevlar.IVDimethylbenzene.getFluid(1_000))
            .fluidOutputs(Materials.Hydrogen.getGas(10_000))
            .duration(21 * SECONDS + 12 * TICKS)
            .eut(60)
            .addTo(electrolyzerRecipes);
