...
public class FormingPressRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTOreDictUnificator.get(OrePrefixes.gear, MaterialsUEVplus.TranscendentMetal, 16),
                GTOreDictUnificator.get(OrePrefixes.plate, MaterialsUEVplus.ProtoHalkonite, 8),
                GGMaterial.preciousMetalAlloy.get(OrePrefixes.ring, 2),
                GGMaterial.metastableOganesson.get(OrePrefixes.screw, 16))
            .fluidInputs(MaterialsUEVplus.DimensionallyShiftedSuperfluid.getFluid(10 * INGOTS))
