...
import gregtech.common.tileentities.machines.multi.MTEIndustrialArcFurnace;
...
public class LoaderMetaTileEntities implements Runnable { // TODO CHECK CIRCUIT RECIPES AND USAGES
    ...
    private static void registerMultiblockControllers() {
        ...
        ItemList.Ore_Processor.set(
            new MTEIntegratedOreFactoryLegacy(
                ...
                "multimachine.orefactory",
                "Ore Factory").getStackForm(1L));
    ...
    private void registerSlicingMachine() {
        ItemList.Machine_LV_Slicer.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICER_LV.ID)
                .setName("basicmachine.slicer.tier.01", "Basic Slicing Machine")
                .setTier(1)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
                .setSound(SoundResource.NONE)
                .setOverlays("SLICER")
                .build()
        ...
        ItemList.Machine_MV_Slicer.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICER_MV.ID)
                .setName("basicmachine.slicer.tier.02", "Advanced Slicing Machine")
                .setTier(2)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.Machine_HV_Slicer.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICER_HV.ID)
                .setName("basicmachine.slicer.tier.03", "Advanced Slicing Machine II")
                .setTier(3)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.Machine_EV_Slicer.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICER_EV.ID)
                .setName("basicmachine.slicer.tier.04", "Advanced Slicing Machine III")
                .setTier(4)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.Machine_IV_Slicer.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICER_IV.ID)
                .setName("basicmachine.slicer.tier.05", "Advanced Slicing Machine IV")
                .setTier(5)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.SlicingMachineLuV.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICING_MACHINE_LuV.ID)
                .setName("basicmachine.slicer.tier.06", "Elite Slicing Machine")
                .setTier(6)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.SlicingMachineZPM.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICING_MACHINE_ZPM.ID)
                .setName("basicmachine.slicer.tier.07", "Elite Slicing Machine II")
                .setTier(7)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.SlicingMachineUV.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICING_MACHINE_UV.ID)
                .setName("basicmachine.slicer.tier.08", "Ultimate Quantum Slicer")
                .setTier(8)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.SlicingMachineUHV.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICING_MACHINE_UHV.ID)
                .setName("basicmachine.slicer.tier.09", "Epic Quantum Slicer")
                .setTier(9)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.SlicingMachineUEV.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICING_MACHINE_UEV.ID)
                .setName("basicmachine.slicer.tier.10", "Epic Quantum Slicer II")
                .setTier(10)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.SlicingMachineUIV.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICING_MACHINE_UIV.ID)
                .setName("basicmachine.slicer.tier.11", "Epic Quantum Slicer III")
                .setTier(11)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
        ...
        ItemList.SlicingMachineUMV.set(
            MTEBasicMachineWithRecipeBuilder.builder(SLICING_MACHINE_UMV.ID)
                .setName("basicmachine.slicer.tier.12", "Epic Quantum Slicer IV")
                .setTier(12)
                .setDescription(MachineType.SLICER.tooltipDescription())
                .setRecipes(slicerRecipes)
                .setSlotsCount(2, 1)
